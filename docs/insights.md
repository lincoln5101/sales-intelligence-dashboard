...
1. Lead with the **Furniture profitability problem** — it's surprising and actionable
2. Walk through the **discount analysis** SQL → show the margin cliff at 20%+
3. Explain the **customer-location modeling decision** — shows you understand real data quirks
4. Show the **Power BI dashboard** with KPI cards matching these numbers ($2.30M / 12.5%)
